...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
  ...
  return (
    <Popover.Root>
      <Popover.Trigger className={clsx("rounded-lg border-2 w-10 h-10 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-500 fucus:ring-offset-2 focus:ring-offset-background", {
