      ...
      {habitsInfo?.possibleHabits.map(habit => {
        return (
          <Checkbox.Root
            ...
            <span className='font-semibold text-xl text-white leading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-500 fucus:ring-offset-2 focus:ring-offset-background'>
              {habit.title}
            </span>
          </Checkbox.Root>
        )
